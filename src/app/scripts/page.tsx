    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.script_content && result.filename) {
          const blob = new Blob([result.script_content], {
            type: "text/plain",
          });
        ...
        alert(
          `✅ Script generated and downloaded successfully!\n\n📄 Filename: ${
            ...
            result.script_content?.length || 0
          } characters\n🔧 Features: ${
            result.features?.join(", ") || "Standard collection"
          }\n📋 Dependencies: ${
            result.dependencies?.join(", ") || "None"
        ...
        if (errorData.detail) {
          if (typeof errorData.detail === "string") {
            ...
            errorMessage = errorData.detail
              .map(
                (
                  err: { msg?: string; loc?: string[]; type?: string } | string
                ) => {
      ...
      alert(
        "Failed to generate script. Please check your connection and try again."
      );
    }
  };
              ...
              <Alert className="max-w-2xl mx-auto border-orange-500/30">
                ...
                <AlertDescription>
                  <div className="space-y-3">
                    ...
                    <p className="text-sm">
                      Run this command to retrieve your authentication token:
                    </p>
                    <div className="bg-muted/50 rounded-lg p-3 font-mono text-xs overflow-x-auto">
                      <pre className="whitespace-pre-wrap break-all">{`curl -X POST ${API_BASE_URL}/auth/login \\
  -H "Content-Type: application/json" \\
  -d '{"username": "your_username", "password": "your_password"}'`}</pre>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Copy the token from the response and paste it in the
                      configuration below
                    </p>
                  </div>
                </AlertDescription>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure your forensic collection script parameters
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select the operating system for script deployment
                  </p>
                </div>
              </div>
                ...
                {[
                  {
                    ...
                    label: "Windows",
                    icon: Laptop,
                    desc: "PowerShell-based collection",
                  },
                  {
                    value: "linux",
                    label: "Linux",
                    icon: Terminal,
                    desc: "Bash/Python collection",
                  },
                  {
                    value: "macos",
                    label: "macOS",
                    icon: Apple,
                    desc: "Unix-based collection",
                  },
                ].map((os) => (
                  <Card
                    key={os.value}
                    ...
                    onClick={() =>
                      updateSimpleConfig("operatingSystem", os.value)
                    }
                  >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select which data types to collect during analysis
                  </p>
                </div>
              </div>
                  ...
                  >
                    <CardContent className="p-4 space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Checkbox
                          checked={
                            config[module.key as keyof ScriptConfig] as boolean
                          }
                          onCheckedChange={(checked) =>
                            updateSimpleConfig(
                              module.key as keyof ScriptConfig,
                              checked
                            )
                          }
                        />
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Configure backend connectivity and data transmission
                  </p>
                </div>
              </div>
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateConfig("server", "url", e.target.value)
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateConfig("server", "authToken", e.target.value)
                        }
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updateConfig("server", "sslVerify", checked)
                      }
                    />
